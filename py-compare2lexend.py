...
# ## Script summary:
    ...
    # 3) The script compares it to `MY_LIST` and asks what kind of report the user wants. The user can also save changes to the original file. 
...
# ■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■
# ■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■
# ✳️DIFF__VERSION- This version of the script does not export right away, instead asks for input
while True:
    last_input = input(f"╟─── (P) Print the results here in the terminal \n╟─── (T) Export results to a new .txt file  \n╟─── (S) Save resulting edits to source file \n╙─── (E) Exit \n>> ").upper()

    valid_inputs = ['P', 'T', 'S', 'E']
    
    while last_input not in valid_inputs:
        last_input = input("♠ Please enter a valid character: ").upper()
